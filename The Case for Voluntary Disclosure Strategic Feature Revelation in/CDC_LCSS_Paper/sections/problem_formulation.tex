...
Let $\cX = \R^d$ be the feature space and $\cY = \R$ be the outcome space. We consider a data-generating process where Nature selects $(u, x, y) \sim (U, X, Y)$ over $\cY \times \cX \times \cY$. Here, $y$ is the ground truth value, $x$ represents the available features, and $u$ is the preferred value.
